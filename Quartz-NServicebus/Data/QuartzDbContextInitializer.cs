...
namespace Quartz_NServicebus.Data
{
    public class QuartzDbContextInitializer : DropCreateDatabaseIfModelChanges<QuartzDbContext>
    {
        ...
        {
            context.DepotSchedules.Add(new DepotSchedule { DepotId = new Guid("5ad03347-4ece-4fe7-8bdb-5de0f5e8336e"), DaysOfTheWeek = "wed,fri", Hour = 14, Minutes = 26 });
            ...
            context.DepotSchedules.Add(new DepotSchedule { DepotId = new Guid("6C69C5F5-7BC3-49F9-86B3-A0BE9C7EA58C"), DaysOfTheWeek = "wed,fri", Hour = 14, Minutes = 35 });
        }
    }

    static class CreattionScripts
    {
        public const string QuartzDbCreation = @"--# thanks to George Papastamatopoulos for submitting this ... and Marko Lahma for
--# updating it.

USE [Quartz_DataStore]
GO
